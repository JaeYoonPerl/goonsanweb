        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="space-y-1">
              <p className="text-sm text-muted-foreground">전화: 063)443-5050</p>
              <p className="text-sm text-muted-foreground">이메일: alumni@gunsan.hs.kr</p>
              <p className="text-sm text-muted-foreground">주소: 전라북도 군산시 죽성로 13</p>
            </div>
          </div>
